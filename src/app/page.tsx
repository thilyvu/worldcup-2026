  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      ...
      <div className="anim-up d2">
        {/* Header row */}
        <div style={{
          display: "grid", gridTemplateColumns: "56px 1fr 70px 70px 80px",
          padding: "8px 20px",
          borderBottom: "1px solid rgba(255,255,255,0.05)",
        }}>
          {["#", "Người chơi", "Đúng", "+VĐ", "Điểm"].map((h, i) => (
          ...
          return (
            <div
              ...
              style={{
                ...
                display: "grid",
                gridTemplateColumns: "56px 1fr 70px 70px 80px",
                alignItems: "center",
                padding: "13px 20px",
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                <div style={{
                  ...
                  background: i === 0
                    ...
                    : i === 2
                    ? "linear-gradient(135deg,#CD7C2E,#7c4a1e)"
              ...
              {/* Champion bonus */}
              <div style={{ textAlign: "right", fontFamily: "var(--font-mono)", fontSize: "0.88rem", color: r.championPoints > 0 ? "#FFB800" : "rgba(232,245,238,0.15)" }}>
                {r.championPoints > 0 ? `+${r.championPoints}` : "—"}
              </div>

              {/* Points */}
              <div className="font-display" style={{
                textAlign: "right",
                fontSize: i < 3 ? "2.2rem" : "1.7rem",
                lineHeight: 1,
                letterSpacing: "0.02em",
                color: i < 3 ? rankColors[i] : "#00E87A",
                filter: i === 0 ? "drop-shadow(0 0 8px rgba(255,184,0,0.4))" : "none",
              }}>
                {r.points}
              </div>
            </div>
      ...
      {/* ── Legend ── */}
      <div className="anim-up d3" style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center" }}>
        {[["Vòng bảng","5"],["1/32","10"],["1/16","20"],["Tứ kết","30"],["Bán kết","40"],["Chung kết","50"],["Vô địch","50"]].map(([l, p]) => (
          <div key={l} style={{
            display: "flex", alignItems: "baseline", gap: 5,
            padding: "4px 12px", borderRadius: 99,
            background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.05)",
          }}>
            <span style={{ fontSize: "0.65rem", color: "rgba(232,245,238,0.28)", fontFamily: "var(--font-barlow)" }}>{l}</span>
            <span className="font-display" style={{ fontSize: "0.95rem", color: "#00E87A", lineHeight: 1 }}>{p}</span>
          </div>
        ))}
      </div>
    </div>
